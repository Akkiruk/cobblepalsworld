...
object VoidBehavior : TagBehavior {
    override val tagType = TagType.VOID
    ...
    override fun doWork(
        ...
        return if (ContainerFinder.isContainer(world, target)) {
            ...
            voidItems(world, pokemonInventory, tag)
        }
    }
    ...
    private fun voidItems(world: World, pokemonInventory: PokemonInventory, tag: TagInstance): WorkResult {
        var changed = false
